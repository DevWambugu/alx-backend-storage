...
<meta name="csrf-token" content="HkY7pJYAppyCLuztsxWjfXcH4SkYP6q6d_D7i1f_yxDkIedbKjjphBc_Y3zpF7cLsyNPmAmVDyrDdMiFQpSnTA" />
  ...
  <form class="sm-gap" id="new_user" action="/auth/sign_in" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="uPMOIkEkoHLtmSA0peXoAz44VlYYWiqKjdgteqe5EZ3UJZiDg2aXR1ongLyOZfcHjNNPmGB1tl0WUdOhBU4t1Q" autocomplete="off" />
